...
public static final String MAIN_WAREHOUSE_REGISTRY_FILE_PATH = "src\\main\\resources\\filesDataSource\\MainRegistry.xml";
...
public static final String START_FXML_FILE = "loginWindow";
public static final String MAIN_MENU = "mainMenuDemo";
    ...
    public static final String TRANSPORT_REGISTRY_WINDOW = "transportRegistryWindow";
    public static final String MAIN_REGISTRY_WINDOW = "warehouseRegistryWindow";
